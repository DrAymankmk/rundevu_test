                            ...
                            <form class="needs-validation" novalidate=""
                                ...
                                <div class="modal-body supervisor-form-grid">
                                    ...
                                    <div class="form-group mt-4">
                                        @php($currentPermissions = $supervisor->permissions->pluck('id')->toArray())
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <label class="mb-0">@lang('admin.supervisor_permissions')</label>
                                        ...
                                        <div class="row">
                                            @foreach($permissions as $permission)
                                                <div class="col-md-4 mb-3">
                                                    <div class="supervisor-permission-card p-3 h-100">
                                                        <h4>{{ $permission->display_name }}</h4>
                                                        @if($permission->child && $permission->child->count())
                                                            @foreach($permission->child as $child)
                                                                <label class="d-flex align-items-center gap-2 mb-2">
                                                                    <input type="checkbox" name="permissions[]" value="{{ $child->id }}" {{ in_array($child->id, $currentPermissions) ? 'checked' : '' }}>
