...
<div class="header no-print d-flex align-items-center justify-content-between px-3">
	<div class="d-flex align-items-center gap-2">
		...
		<a id="toggle_btn" class="p-0" href="javascript:void(0);"><img src="/assets/img/icons/bar-icon.svg"
				alt=""></a>
	...
	<ul class="nav user-menu gap-2">
		<li class="nav-item m-0 desktop-language-switch">
			@if(\Illuminate\Support\Facades\Session::get('lang') == 'en' || app()->getLocale() ==
			'en')
			<a onclick="changeLang()" href="{{URL::to('changeLanguageAdmin','ar')}}"
				class="hasnotifications nav-link" aria-label="Change language to Arabic">
			...
			@else
			<a onclick="changeLang()" href="{{URL::to('changeLanguageAdmin','en')}}"
				class="hasnotifications nav-link" aria-label="Change language to English">
				<i class="fa-solid fa-globe"></i>
		...
		<li class="nav-item dropdown d-none d-sm-block m-0">
			<a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown"><img
					src="/assets/img/icons/note-icon-02.svg" alt=""><span
					class="pulse"></span> </a>
		...
		<li class="nav-item dropdown d-none d-sm-block m-0">
			<a href="javascript:void(0);" id="open_msg_box" class="hasnotifications nav-link"><img
					src="/assets/img/icons/note-icon-01.svg" alt=""><span
					class="pulse"></span> </a>
		</li>
		<li class="nav-item dropdown has-arrow user-profile-list m-0">
			...
			<div class="dropdown-menu">
				<a class="dropdown-item"
					href="{{ route('profile') }}">@lang('admin.doctor.personal_information')</a>
				<a class="dropdown-item" href="{{ route('admin.logout') }}">@lang('admin.Sign
					out')</a>
			</div>
		</li>
	</ul>
...
<div class="header no-print clean-admin-header d-flex align-items-center justify-content-between px-3">
	...
	<div class="header-main-actions d-flex align-items-center">
			...
			<li class="nav-item dropdown has-arrow user-profile-list">
				...
				<div class="dropdown-menu">
					<a class="dropdown-item"
						href="{{ route('profile') }}">@lang('admin.doctor.personal_information')</a>
					<a class="dropdown-item"
						href="{{ route('admin.logout') }}">@lang('admin.Sign
						out')</a>
				</div>
			</li>
		...
		<div class="mobile-language-switch d-sm-none d-flex">
			@if(\Illuminate\Support\Facades\Session::get('lang') == 'en' || app()->getLocale() ==
			'en')
			<a href="{{URL::to('changeLanguageAdmin','ar')}}" class="hasnotifications nav-link"
				aria-label="Change language to Arabic">
				<i class="fa-solid fa-globe"></i>
				<img src="/assets/img/ar.png" alt="">
				<span>AR</span>
			...
			@else
			<a href="{{URL::to('changeLanguageAdmin','en')}}" class="hasnotifications nav-link"
				aria-label="Change language to English">
				<i class="fa-solid fa-globe"></i>
				<img src="/assets/img/en.jpg" alt="">
				<span>EN</span>
