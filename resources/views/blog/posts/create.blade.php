	...
	<div class="row">
		<div class="col-12">
			<div class="page-title-box">
				...
				<h4 class="page-title">{{ __('blog.add_post') }}</h4>
			</div>
		</div>
	</div>
							...
							<div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}"
								...
								<div class="mb-3">
									...
									<textarea class="form-control @error('translations.'.$lang->code.'.summary') is-invalid @enderror"
										...
										rows="3"
										dir="{{ $lang->direction }}"
										required>{{ old('translations.'.$lang->code.'.summary') }}</textarea>
								...
								@include('components.rich-text-editor', [
									...
									'value' => old('translations.'.$lang->code.'.content'),
								...
								<div class="mb-3 mt-3">
									...
									<input type="text"
										...
										value="{{ old('translations.'.$lang->code.'.tags') }}"
										dir="{{ $lang->direction }}"
					...
					<div class="card-body">
						...
						<div class="d-grid">
							<button type="submit" class="btn btn-primary" {{ $languages->isEmpty() ? 'disabled' : '' }}>
								<i class="mdi mdi-content-save"></i> {{ __('blog.save_post') }}
							</button>
						</div>
					</div>
				</div>
