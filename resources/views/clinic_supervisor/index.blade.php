...
@section('content')
        ...
        <div class="container-fluid">
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        <div class="page-header-left">
                            <a class="btn btn-square btn-primary" href="{{route('clinic.supervisor.create')}}"
                                    ...
                                    <table class="display dataTable" id="basic-1">
                                        ...
                                        @foreach($all_supervisor as $index=>$account)
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{route('clinic.supervisor.edit',$account->id)}}"
                                                    ...
                                                    <form action="{{ route('clinic.supervisor.destroy', $account->id) }}"
    ...
    <script>
        ...
        function change_status_account(id, value) {
            ...
            axios.get('{{ url("admin/clinic/update-status-supervisor") }}/' + id + '/' + value)
