		...
		<div class="row gy-4 justify-content-center">
			<div class="col-md-6 col-xl-4 feature-card_wrapp wow fadeInLeft" data-wow-delay=".2s">
				<div class="feature-card th-ani">
					<h3 class="box-title text-anime-style-2">Need Immediate
						Care?</h3>
			...
			<div class="col-md-6 col-xl-4 feature-card_wrapp wow fadeInUp" data-wow-delay=".4s">
				<div class="feature-card th-ani">
					<h3 class="box-title text-anime-style-2">Quality & Patient
						Safety</h3>
					<p class="box-text">Medova clinic is equipped with best
						world class machinery & reagents. amet
						consectetur.</p>
			...
			<div class="col-md-6 col-xl-4 feature-card_wrapp wow fadeInRight" data-wow-delay=".6s">
				<div class="feature-card th-ani">
					<h3 class="box-title text-anime-style-2">Unlock Your
						Wellness Journey</h3>
					<p class="box-text">Medova clinic is equipped with best
						world class machinery & reagents. amet
						consectetur.</p>
