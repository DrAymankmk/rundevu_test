...
$normalized = preg_replace('#<br\s* /?>#i', "\n", (string) $content);
	...
	<div class="">
		<div class="contact-map">
			<iframe src="https://www.google.com/maps?q=24.4628363,39.5779308&z=17&hl=en&output=embed"
				title="{{ __('main.address_text') }}"
				allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
			<div class="contact-icon">
				<img src="{{ asset('frontend/assets/img/icon/location-dot.svg') }}" alt="" decoding="async" loading="lazy">
			</div>
		</div>
	</div>