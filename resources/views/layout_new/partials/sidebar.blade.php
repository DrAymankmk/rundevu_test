    ...
    <div class="sidebar-logo">
        <div>
            ...
            <a href="{{url('index')}}" class="logo logo-normal">
                <img src="{{URL::asset('media/logo/logo_header.png')}}" alt="Randevou" style="width:60px;height:60px;object-fit:contain">
            </a>

            <!-- Logo Small -->
            <a href="{{url('index')}}" class="logo-small">
                <img src="{{URL::asset('media/logo/logo_header.png')}}" alt="Randevou">
            </a>
                ...
                <ul>
                    ...
                    <li>
                        <ul>
                            ...
                            <li class="{{ Request::is('admin/emergency-hospitals*', 'emergency-hospitals*') ? 'active' : '' }}">
                                <a href="{{ route('emergency-hospitals.index') }}">
                                    <i class="ti ti-emergency-bed"></i><span>مستشفيات الطوارئ</span>
                                </a>
                            </li>
