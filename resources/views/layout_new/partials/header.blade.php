...
<header class="navbar-header">
	<div class="page-container topbar-menu">
			...
			<a href="{{url('index')}}" class="logo">
				...
				<span class="logo-light">
					<span class="logo-lg"><img
							src="{{URL::asset('media/logo/logo_header.png')}}"
							alt="Randevou"></span>
		...
		@if (!Route::is(['doctor-dashboard', 'doctors-appointments', 'doctors-appointment-details',
		'doctors-patient-details', 'online-consultations', 'doctors-schedules', 'doctors-prescriptions',
		'doctors-prescription-details', 'doctors-leaves', 'doctors-reviews', 'doctors-profile-settings',
		...
		<div class="d-flex align-items-center">
			...
			<div class="header-item d-flex d-lg-none me-2">
				<button class="topbar-link btn btn-icon" data-bs-toggle="modal"
			...
			<!-- Language Switch -->
			@if(app()->getLocale() == 'ar')
			<a href="{{ URL::to('changeLanguageAdmin','en') }}" class="btn btn-liner-gradient me-3"
				title="Switch to English">
				<i class="ti ti-world"></i>
				<span>English</span>
			</a>
			@else
			<a href="{{ URL::to('changeLanguageAdmin','ar') }}" class="btn btn-liner-gradient me-3"
			...
			<div class="header-item">
				<div class="dropdown me-2">
					<a href="{{route('clinics')}}" class="btn topbar-link"><i
			...
			<div class="header-item d-none d-sm-flex me-2">
				<button class="topbar-link btn btn-icon topbar-link" id="light-dark-mode"
					type="button">
				...
				<div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-2">
					...
					<div class="d-flex align-items-center bg-light rounded-3 p-2 mb-2">
						...
						<div class="ms-2">
							<p class="fw-medium text-dark mb-0">
								{{ Auth::user()->name ?? null }}</p>
							<span
								class="d-block fs-13">{{ trans('admin.system_manager') }}</span>
						</div>
					</div>
					...
					<div
						...
						<label class="form-check-label" for="notify"><i
								class="ti ti-bell me-1"></i>{{ app()->getLocale() == 'ar' ? 'الإشعارات' : 'Notifications' }}</label>
						<input class="form-check-input me-0" type="checkbox"
							role="switch" id="notify">
					</div>
					...
					<div class="pt-2 mt-2 border-top">
						<a href="{{ route('admin.logout') }}"
							...
							<span
								class="align-middle">{{ trans('admin.logout') }}</span>
						</a>
					</div>
				</div>
			</div>
						...
						<div class="notification-body position-relative z-2 rounded-0"
							...
							<div class="dropdown-item notification-item py-3 text-wrap border-bottom"
								...
								<div class="d-flex">
									...
									<div class="flex-grow-1">
										<p
											class="mb-0 fw-medium text-dark">
											Dr. Smith
										</p>
										<p
							...
							<!-- Item-->
							<div class="dropdown-item notification-item py-3 text-wrap"
								id="notification-4">
								<div class="d-flex">
									<div
										class="me-2 position-relative flex-shrink-0">
				...
				<div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-2">
					...
					<div class="d-flex align-items-center bg-light rounded-3 p-2 mb-2">
						<img src="{{URL::asset('build/img/doctors/doctor-01.jpg')}}"
							...
							alt="">
						<div class="ms-2">
							<p class="fw-medium text-dark mb-0">Dr.Michael
								Smith</p>
		...
		@if (Route::is(['patient-dashboard', 'patient-appointments', 'patient-appointment-details',
		'patients-doctor-details', 'patient-doctors', 'patient-prescriptions',
		'patient-prescription-details', 'patient-invoices', 'patient-invoice-details',
		'patient-profile-settings', 'patient-password-settings', 'patient-notifications-settings',
		'patient-notifications']))
