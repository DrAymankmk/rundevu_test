        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <a href="{{url('index')}}" class="logo">
                ...
                <span class="logo-light">
                    <span class="logo-lg"><img src="{{URL::asset('media/logo/logo_header.png')}}" alt="Randevou"></span>
                    <span class="logo-sm"><img src="{{URL::asset('media/logo/logo_header.png')}}" alt="Randevou"></span>
                </span>
                        ...
                        <div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg" style="min-height: 300px;">
                            ...
                            <div class="p-2 border-bottom">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h6 class="m-0 fs-16 fw-semibold">{{ app()->getLocale() == 'ar' ? 'الإشعارات' : 'Notifications' }}</h6>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-2">
                        ...
                        <div class="d-flex align-items-center bg-light rounded-3 p-2 mb-2">
                            ...
                            <div class="ms-2">
                                ...
                                <span class="d-block fs-13">{{ trans('admin.system_manager') }}</span>
                            </div>
                        </div>
