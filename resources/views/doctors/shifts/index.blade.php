                ...
                <div class="row">
                    <div class="col-sm-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">@lang('admin.shifts_item') {{ $employee->name }}</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table border-0 custom-table comman-table datatable mb-0">
                                    ...
                                    <tbody>
                                    @foreach($employee_shifts as $index=>$shift)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            <td>{{ $shift->shift->name ?? null }}</td>
                                            <td>{{ $shift->dateA }}</td>
                                            <td>{{ $shift->shift->time_from ?? null }}</td>
                                            <td>{{ $shift->shift->time_to ?? null }}</td>
                                            <td>{{ $shift->shift->minute_allow_delay ?? null }}</td>
