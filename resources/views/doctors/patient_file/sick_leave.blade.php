...
@section('content')
    ...
    <!-- Inside the <head> section of your Blade view -->
    ...
    <div class="page-wrapper">
        <div class="content">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><i class="feather-chevron-right"></i><a href="{{ route('patient-file',$user->id) }}">@lang('admin.file') </a></li>
                            <li class="breadcrumb-item active">@lang('admin.sick_leave')</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card-box">
                        <h4 class="card-title text-center">@lang('admin.sick_leave_report') ({{ $user->name }})</h4>
                        <form method="POST" action="{{route('create-sick-leave', $reservation->id)}}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="works" required value="{{$data['sick_leave_reservation']->works ?? old('works')}}"
                                           class="form-control">
                                </div>

                                <label class="col-form-label col-md-2">@lang('admin.Workplace')</label>
                                <div class="col-md-4">
                                    <input type="text" name="Workplace" required value="{{$data['sick_leave_reservation']->Workplace ?? old('Workplace')}}"
                                           class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <label class="col-form-label col-md-12">
                                    <input type="checkbox" name="medical_company"
                                           @if ($data['sick_leave_reservation']->medical_company ?? null == 1) checked @endif
                                           value="1">
                                ...
                                <label class="col-form-label col-md-12">
                                    <input type="checkbox" name="impossible_treat"
                                           @if ($data['sick_leave_reservation']->impossible_treat ?? null == 1) checked @endif
                                           value="1">
                                    @lang('admin.impossible_treat')
                                </label>
                                <label class="col-form-label col-md-12">
                                    <input type="checkbox" name="physician_leave"
                                           @if ($data['sick_leave_reservation']->physician_leave ?? null == 1) checked @endif
                                           value="1">
