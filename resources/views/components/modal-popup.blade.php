        ...
        <div class="offcanvas-body pt-0 px-0">
            ...
            <div class="px-3 my-3">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <div>  <a href="{{url('online-consulation')}}" class="btn-primary btn btn-sm rounded d-flex align-items-center"> <i class="ti ti-video me-1 fs-13"></i> Start </a></div>
                </div>
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6">
                        <p class="text-dark"> Status </p>
...
@if (Route::is(['doctors-leaves']))
    ...
    <div class="modal fade" id="edit-leave">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-dark fw-bold">Edit Leave</h5>
                    <button type="button" class="btn-close btn-close-modal" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
