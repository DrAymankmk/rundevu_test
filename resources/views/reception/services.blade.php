                    ...
                    <div class="col-sm-12">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a
                                    href="{{ route('patients') }}">@lang('admin.reception.reception') </a></li>
                            <li class="breadcrumb-item px-2"><i id="breadcrumbArrow"></i></li>
                            <li class="breadcrumb-item active">@lang('admin.List of services')</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card card-table show-entire">
                        <div class="card-body">
                            ...
                            <div class="staff-search-table">
                                <form
                                    action="{{route('services', $patient_id)}}"
                                    ...
                                    <table class="table border-0 custom-table comman-table datatable mb-0">
                                        ...
                                        @foreach($patient_services as $service)
                                            <tr>
                                                ...
                                                <td>@if($service->user->company_id != null)
                                                        @lang('admin.insurance')
                                                    @else
                                                        @lang('admin.cash')
                                                    @endif</td>
                                                <td><a href="javascript:;">{{ $service->user->file_number ?? null }}</a></td>
                                                <td class="d-flex gap-1">
                                                    @if($service->confirm == 0)
                                                    <a href="javascript:void(0)"
                                                       class="text-success font-18 add-table-invoice success"
                                                       data-bs-toggle="modal"
                                                       data-bs-target="#confirm_service{{$service->id}}"
                                                       data-service-id="{{$service->id}}"
                                                       title="Confirm"><i class="fa fa-check"></i></a>
                                                    @endif
                                                        @if($service->status == 0)
                                                        <a href="javascript:void(0)" data-bs-toggle="modal"
                                                           data-bs-target="#transfer_service{{$service->id}}"
                                                           data-service-id="{{$service->id}}"
                                                       class="text-success font-18 add-table-invoice transfer_service"
                                                       title="Transfer"><i class="fa fa-right-left"></i></a>
                                                        @endif
                                                </td>
