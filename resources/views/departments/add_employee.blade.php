                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6 mb-3" style="display: none">
                                            ...
                                            <input class="form-control" id="validationCustom03" type="password"
                                                   placeholder="@lang('admin.password')" value="12345678"
                                                   name="password">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input class="form-control" id="consultation_price" type="number"
                                                       step="0.01" min="0"
                                                       placeholder="@lang('admin.enter_consultation_price')" value="{{ old('consultation_price') }}"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <textarea class="form-control" id="info_ar"
                                                          ...
                                                          name="info_ar" rows="3">{{ old('info_ar') }}</textarea>
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <textarea class="form-control" id="info"
                                                          ...
                                                          name="info" rows="3">{{ old('info') }}</textarea>
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3" style="display: none">
                                                ...
                                                <input class="form-control" id="appointments_online" type="number"
                                                       placeholder="@lang('admin.Percentage of offline patient')" value="50"
