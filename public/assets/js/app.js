...
$(document).ready(function($) {
    ...
    $(".add-table-items-analysis").on('click','.remove-btn', function () {
        $(this).closest('.add-row-analysis').remove();
        return false;
    });

    $(".add-table-items-rays").on('click','.remove-btn', function () {
        $(this).closest('.add-row-rays').remove();
        return false;
    });

    $(".add-table-items-services").on('click','.remove-btn', function () {
        $(this).closest('.add-row-services').remove();
        return false;
    });
		 // Editor
		if ($('#editor').length > 0) {
