...
(function (h) {
    ...
    u("rows().indexes()", "row().paymentForm()", function () {
        return this.iterator("row", function (a,
                                              b) {
            return b
        }, 1)
    ...
    u("columns().indexes()", "column().paymentForm()", function (a) {
    ...
    o("column.paymentForm()", function (a, b) {
    ...
    u("cells().indexes()", "cell().paymentForm()", function () {
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: "عرض _START_ من _END_ مجموع _TOTAL_ المدخلات",
            sInfoEmpty: "عرض المدخلات",
